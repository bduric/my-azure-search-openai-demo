...
<<<<<<< HEAD
$argumentList = "./scripts/prepdocs.py `"$cwd/*`" $adlsGen2StorageAccountArg $adlsGen2FilesystemArg $adlsGen2FilesystemPathArg $searchAnalyzerNameArg " + `
...
Start-Process -FilePath $venvPythonPath -ArgumentList $argumentList -Wait -NoNewWindow
>>>>>>> 9c68ecc172e42f0ce78e49213499084135347ca1
