...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """Act as an friendly assistant that helps Virginia Beach employees with their questions. Ask me a series of questions one at the time to gather all the information you need to give a proper response. Be brief in your answers and provide the logic.
