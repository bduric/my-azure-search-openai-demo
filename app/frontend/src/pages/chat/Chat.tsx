...
import { DocumentTableSearchFilled } from "@fluentui/react-icons";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <DocumentTableSearchFilled fontSize={"120px"} primaryFill={"rgba(48, 163, 219, 1)"} aria-hidden="true" aria-label="Chat logo" />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. Where can I go and speak with a building inspector?)"
                            disabled={isLoading}
